...
class DRoboClawFS
   ...
   public :
      ...
      ***********************************************************************/
      ...
      // Verified TTC
      bool SetEncoder1Mode(EncoderMode Mode) const noexcept
         {
      ...
      // Verified TTC
      bool SetEncoder2Mode(EncoderMode Mode) const noexcept
         {
      ...
      bool WriteSettingsToEEPROM() const noexcept
         {
      ...
      bool ReadSetttingsFromEEPROM() const noexcept
         {
      ...
      bool SetStandardConfigSettings(uint16_t uConfig) const noexcept
         {
      ...
      // ????
      bool ReadStandardConfigSettings(uint16_t& uConfig) const noexcept
         {
      ...
      bool SetCTRLModes(ECTRLMode eMode1, ECTRLMode eMode2) const noexcept
         {
      ...
      bool ReadCTRLModes(ECTRLMode& eMode1, ECTRLMode& eMode2) const noexcept
         {
         uint8_t uMode1, uMode2;
      ...
      //** Cmd 102 Set CTRL 1
      bool SetCTRL1(uint16_t uValue) const noexcept
         {
         return (Send1IntegralType0xFF(ECommandCode::eSetCTRL1, uValue));
         }

      //** Cmd 103 Set CTRL 2
      bool SetCTRL2(uint16_t uValue) const noexcept
         {
         return (Send1IntegralType0xFF(ECommandCode::eSetCTRL2, uValue));
         }

      //** Cmd 104 Read CTRL Values
      bool ReadCTRLs(uint16_t& uCTRL1, uint16_t& uCTRL2) const noexcept
         {
      ...
      // Verified TTC
      bool SetM1MaxCurrentLimit(uint32_t uMaxCurrent, uint32_t uMinCurrent = 0) const noexcept
         {
         return (SetMaxCurrentLimit(ECommandCode::eSetM1MaxCurrentLimit,  uMaxCurrent, uMinCurrent));
         }

      // Set M1 Max Current Limit in Amps
      bool SetM1MaxCurrentLimit(float fMaxCurrent, float fMinCurrent = 0.0f) const noexcept
         {
      ...
      // Manual shows 4 zeros for the second parameter.  The Min Current is ignored and aways zero.
      // Verified TTC
      bool SetM2MaxCurrentLimit(uint32_t uMaxCurrent, uint32_t uMinCurrent = 0) const noexcept
         {
         return (SetMaxCurrentLimit(ECommandCode::eSetM2MaxCurrentLimit, uMaxCurrent, uMinCurrent));
         }

      // Set M2 Max Current Limit in Amps
      bool SetM2MaxCurrentLimit(float fMaxCurrent, float fMinCurrent = 0.0f) const noexcept
         {
      ...
      bool SetMotorMaxCurrentLimit(uint8_t uMotor, uint32_t uMaxCurrent, uint32_t uMinCurrent = 0) const noexcept
         {
         return (SetMaxCurrentLimit(MotorCmd(ECommandCode::eSetM1MaxCurrentLimit, uMotor),  uMaxCurrent, uMinCurrent));
         }

      bool SetMotorMaxCurrentLimit(uint8_t uMotor, float fMaxCurrent, float fMinCurrent = 0.0f) const noexcept
         {
      ...
      // Verified TTC
      bool ReadM1MaxCurrentLimit(uint32_t& uMaxCurrent, uint32_t& uMinCurrent) const noexcept
         {
      ...
      bool ReadM1MaxCurrentLimit(uint32_t& uMaxCurrent) const noexcept
         {
      ...
      bool ReadM1MaxCurrentLimit(float& fMaxCurrent, float& fMinCurrent) const noexcept
         {
      ...
      // Read M1 Max Current Limit in Amps
      bool ReadM1MaxCurrentLimit(float& fMaxCurrent) const noexcept
         {
         float fMinCurrent;
      ...
      // Min Current is always zero
      // Verified TTC
      bool ReadM2MaxCurrentLimit(uint32_t& uMaxCurrent, uint32_t& uMinCurrent) const noexcept
         {
         return (ReadMaxCurrentLimit(ECommandCode::eReadM2MaxCurrentLimit, uMaxCurrent, uMinCurrent));
         }

      // Convenience to prevent handling an unused value
      bool ReadM2MaxCurrentLimit(uint32_t& uMaxCurrent) const noexcept
         {
         uint32_t uMinCurrent;
         return (ReadMaxCurrentLimit(ECommandCode::eReadM2MaxCurrentLimit, uMaxCurrent, uMinCurrent));
         }
      ...
      bool ReadM2MaxCurrentLimit(float& fMaxCurrent, float& fMinCurrent) const noexcept
         {
         uint32_t uMaxCurrent, uMinCurrent;
      ...
      // Read M2 Max Current Limit in Amps
      bool ReadM2MaxCurrentLimit(float& fMaxCurrent) const noexcept
         {
         float fMinCurrent;
      ...
      bool ReadMotorMaxCurrentLimit(uint8_t uMotor, uint32_t& uMaxCurrent, uint32_t& uMinCurrent) const noexcept
         {
      ...
      // Convenience to prevent handling an unused value
      bool ReadMotorMaxCurrentLimit(uint8_t uMotor, uint32_t& uMaxCurrent) const noexcept
         {
         uint32_t uMinCurrent;
         return (ReadMaxCurrentLimit(MotorCmd(ECommandCode::eReadM1MaxCurrentLimit, uMotor),
               uMaxCurrent, uMinCurrent));
      ...
      bool ReadMotorMaxCurrentLimit(uint8_t uMotor, float& fMaxCurrent, float& fMinCurrent) const noexcept
         {
         uint32_t uMaxCurrent, uMinCurrent;
      ...
      // Read Motor Max Current Limit in Amps
      bool ReadMotorMaxCurrentLimit(uint8_t uMotor, float& fMaxCurrent) const noexcept
         {
         float fMinCurrent;
      ...
      // Verified TTC
      bool SetPWMMode(EPWMMode ePWMMode) const noexcept
         {
      ...
      // Verified TTC
      bool ReadPWMMode(EPWMMode& ePWMMode) const noexcept
         {
         uint8_t uPWMMode;
      ...
      ***********************************************************************/
      ...
      bool SetM1VelocityPIDConstants(uint32_t uP = 0x0010000, uint32_t uI = 0x00008000,
            uint32_t uD = 0x00004000, uint32_t uMaxSpeed = 44000) const noexcept
         {
      ...
      // Verified TTC
      bool DriveM1SignedDutyCycle(int16_t nDutyCycle) const noexcept
         {
      ...
      bool DriveM1SignedDutyCycle(float fDutyCycle) const noexcept
         {
      ...
      // Value is -32,767 to +32,767 (-100% to +100%)
      bool DriveM2SignedDutyCycle(int16_t nDutyCycle) const noexcept
         {
      ...
      bool DriveM2SignedDutyCycle(float fDutyCycle) const noexcept
         {
         return (DriveM2SignedDutyCycle(static_cast<int16_t>(fDutyCycle * 327.67)));
         }

      // Drive Signed Duty Cycle by Motor Number
      bool DriveMotorSignedDutyCycle(uint8_t uMotor, int16_t nDutyCycle) const noexcept
         {
      ...
      bool DriveSignedDutyCycle(uint8_t uMotor, float fDutyCycle) const noexcept
         {
      ...
      // Value is -32,767 to +32,767 (-100% to +100%)
      bool DriveBothSignedDutyCycle(int16_t nDutyCycle1, int16_t nDutyCycle2) const noexcept
         {
      ...
      bool DriveBothSignedDutyCycle(float fDutyCycle1, float fDutyCycle2) const noexcept
         {
      ...
      bool DriveM1SignedSpeed(int32_t nSpeed) const noexcept
         {
      ...
      // Speed is in quadrature pulses/second
      bool DriveM2SignedSpeed(int32_t nSpeed) const noexcept
         {
      ...
      // Speed is in quadrature pulses/second
      bool DriveMotorSignedSpeed(uint8_t uMotor, int32_t nSpeed) const noexcept
         {
      ...
      // Speed is in quadrature pulses/second
      bool DriveBothSignedSpeed(int32_t nSpeed1, int32_t nSpeed2) const noexcept
         {
      ...
      bool DriveM1SignedSpeedAccel(int32_t nSpeed, uint32_t uAccel) const noexcept
         {
      ...
      // Sign on speed indicates the direction, acceleration is not signed.
      bool DriveM2SignedSpeedAccel(int32_t nSpeed, uint32_t uAccel) const noexcept
         {
      ...
      // Sign on speed indicates the direction, acceleration is not signed.
      bool DriveMotorSignedSpeedAccel(uint8_t uMotor, int32_t nSpeed, uint32_t uAccel) const noexcept
         {
      ...
      bool DriveBothSignedSpeedAccel(int32_t nSpeed1, int32_t nSpeed2, uint32_t uAccel) const noexcept
         {
      ...
      bool DriveM1SignedSpeedDistance(int32_t nSpeed, uint32_t uDistance,
            bool bImmediate = true) const noexcept
         {
      ...
      bool DriveBothSignedSpeedDistance(int32_t nSpeed1, uint32_t uDistance1,
            int32_t nSpeed2, uint32_t uDistance2, bool bImmediate = true) const noexcept
         {
      ...
      bool ReadBufferLength(uint8_t& uLen1, uint8_t& uLen2) const noexcept
         {
      ...
      bool DriveBothSignedSpeedIndividualAccel(int32_t nSpeed1, uint32_t uAccel1,
            int32_t nSpeed2, uint32_t uAccel2) const noexcept
         {
      ...
      bool DriveBothSignedSpeedIndividualAccelDist(int32_t nSpeed1, uint32_t uAccel1, uint32_t uDist1,
            int32_t nSpeed2, uint32_t uAccel2, uint32_t uDist2, bool bImmediate = true) const noexcept
         {
      ...
      bool DriveM1SignedDutyAccel(int16_t nDuty, uint16_t uAccel) const noexcept
         {
      ...
      bool DriveM1SignedDutyAccel(float fDuty, float fAccel) const noexcept
         {
      ...
      // The accel value range is 0 to 65535(eg maximum acceleration rate is -100% to 100% in 100ms).
      // The manual says accel max is 655359.  Typo????
      bool DriveM2SignedDutyAccel(int16_t nDuty, uint16_t uAccel) const noexcept
         {
         return (DriveSignedDutyAccel(ECommandCode::eDriveM2SignedDutyAccel, nDuty, uAccel));
         }

      // Duty in percent (-100% to 100%), Accel in percent (0% to 100%)
      bool DriveM2SignedDutyAccel(float fDuty, float fAccel) const noexcept
         {
      ...
      // The accel value range is 0 to 65535(eg maximum acceleration rate is -100% to 100% in 100ms).
      // The manual says accel max is 655359.  Typo????
      bool DriveMotorSignedDutyAccel(uint8_t uMotor, int16_t nDuty, uint16_t uAccel) const noexcept
         {
         return (DriveSignedDutyAccel(MotorCmd(ECommandCode::eDriveM1SignedDutyAccel, uMotor), nDuty, uAccel));
         }

      // Duty in percent (-100% to 100%), Accel in percent (0% to 100%)
      bool DriveMotorSignedDutyAccel(uint8_t uMotor, float fDuty, float fAccel) const noexcept
         {
      ...
      // The accel value range is 0 to 65535(eg maximum acceleration rate is -100% to 100% in 100ms).
      // The manual says accel max is 655359.  Typo????
      bool DriveBothSignedDutyAccel(int16_t nDuty1, uint16_t uAccel1, int16_t nDuty2, uint16_t uAccel2) const noexcept
         {
      ...
      // Duty in percent (-100% to 100%), Accel in percent (0% to 100%)
      bool DriveBothSignedDutyAccel(float fDuty1, float fAccel1, float fDuty2, float fAccel2) const noexcept
         {
      ...
      // uMaxSpeed is the motor speed in QPPS at 100% power
      // Verified TTC
      bool ReadM1VelocityPIDConstants(uint32_t& uP, uint32_t& uI, uint32_t& uD, uint32_t& uMaxSpeed) const noexcept
         {
      ...
      // uMaxSpeed is the motor speed in QPPS at 100% power
      // Verified TTC
      bool ReadM2VelocityPIDConstants(uint32_t& uP, uint32_t& uI, uint32_t& uD, uint32_t& uMaxSpeed) const noexcept
         {
      ...
      // uMaxSpeed is the motor speed in QPPS at 100% power
      // Verified TTC
      bool ReadMotorVelocityPIDConstants(uint8_t uMotor, uint32_t& uP, uint32_t& uI, uint32_t& uD,
            uint32_t& uMaxSpeed) const noexcept
         {
      ...
      bool SetM1PositionPIDConstants(uint32_t uP, uint32_t uI, uint32_t uD, uint32_t uMaxIWindup,
            uint32_t uDeadzone, int32_t nMinPos, int32_t nMaxPos) const noexcept
         {
      ...
      bool DriveM1SignedSpeedAccelDecelPos(int32_t nSpeed, uint32_t uAccel, uint32_t uDecel,
            int32_t nPos, bool bImmediate = true) const noexcept
         {
      ...
      bool DriveBothSignedSpeedAccelDecelPos(int32_t nSpeed1, uint32_t uAccel1, uint32_t uDecel1,
            ...
            int32_t nPos2, bool bImmediate = true) const noexcept
         {
      ...
      // Stop motors without invoking EStop
      void STOP() const noexcept
         {
         DriveBothSignedSpeed(0, 0);
         return;
         }
   ...
   protected :
      ...
      static constexpr ECommandCode MotorCmd(ECommandCode eCmd, uint8_t uMotor)  noexcept
         {
      ...
      static constexpr uint8_t BufferCommand(bool bImmediate) noexcept
         {
         return (bImmediate ? 1 : 0);
         }

      // Calculate the CRC
      static CRC16 CalcCRC16(size_t nBytes, uint8_t Packet[]) noexcept
         {
         CRC16 CRC = 0;
      ...
      static CRC16 UpdateCRC16(CRC16 CRC, size_t nBytes, uint8_t Packet[]) noexcept;

      // Command send methods
      bool SendCmdBlockCRC(ECommandCode eCmd, int nBytes, uint8_t* pData) const noexcept;

      // Send command and calculate CRC
      bool SendHeader(ECommandCode eCmd, CRC16* pCRC = nullptr) const noexcept;

      // Send command and CRC  (Command has no data)
      bool SendHeaderCRC(ECommandCode eCmd, CRC16* pHeaderCRC = nullptr) const noexcept;

      // Send Command, CRC, (no data), and Receive 0xFF
      bool SendHeaderCRC0xFF(ECommandCode eCmd) const noexcept;

      // Send Command, one data byte, and CRC.
      // Return Header CRC if requested to check command response
      bool SendHeaderByteCRC(ECommandCode eCmd, uint8_t uData, CRC16* pHeaderCRC = nullptr) const noexcept;
      ...
      bool SendSimpleCommand(ECommandCode eCmd) const noexcept
         {
         return (SendHeader(eCmd) && Receive0xFF());
         }

      // Send Command, one byte data, CRC, and receive ACK 0xFF
      bool SendHeaderByteCRC0xFF(ECommandCode eCmd, uint8_t uData) const noexcept;

      bool SendBlock(size_t nSize, uint8_t* pBlock, uint8_t& CRC) const noexcept;

      bool SendCRC(CRC16 CRC) const noexcept
         {
         return (SendIntegralType(CRC));
         }

      // Send a compativility mode command and receive the ack
      bool SendCompatibilityCmd(ECommandCode eCmd, uint8_t nData) const noexcept;

      // Read one byte and compare to 0xFF
      bool Receive0xFF() const noexcept
         {
         uint8_t uByte;
      ...
      template <typename T>
      bool SendIntegralType(T nInteger, CRC16* pCRC = nullptr) const noexcept
         {
      ...
      template <typename T>
      bool ReadIntegralType(T& nInteger, CRC16* pCRC = nullptr) const noexcept
         {
         T nReceive = 0;
      ...
      **************/
      ...
      template <typename T>
      bool Send1IntegralType0xFF(ECommandCode eCmd, T V) const noexcept
         {
         CRC16 CRC;
      ...
      template <typename T>
      bool Read1IntegralTypeCRC(ECommandCode eCmd, T& V) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send2IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      template <typename T1, typename T2>
      bool Read2IntegralTypesCRC(ECommandCode eCmd, T1& V1, T2& V2) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send3IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2, T3 V3) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      template <typename T1, typename T2, typename T3>
      bool Read3IntegralTypesCRC(ECommandCode eCmd, T1& V1, T2& V2, T3& V3) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send4IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2, T3 V3, T4 V4) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      template <typename T1, typename T2, typename T3, typename T4>
      bool Read4IntegralTypesCRC(ECommandCode eCmd, T1& V1, T2& V2, T3& V3, T4& V4) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send5IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2, T3 V3, T4 V4, T5 V5) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send6IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2, T3 V3, T4 V4, T5 V5, T6 V6) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send7IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2, T3 V3, T4 V4, T5 V5, T6 V6, T7 V7) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
      bool Read7IntegralTypesCRC(ECommandCode eCmd, T1& V1, T2& V2, T3& V3, T4& V4, T5& V5, T6& V6,
            T7& V7) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool Send9IntegralTypes0xFF(ECommandCode eCmd, T1 V1, T2 V2, T3 V3, T4 V4, T5 V5, T6 V6,
            T7 V7, T8 V8, T9 V9) const noexcept
         {
         CRC16 CRC;
         bool bRet = SendHeader(eCmd, &CRC);
         if (bRet)
      ...
      bool SendBlock(size_t nSize, uint8_t* pBlock, CRC16* pCRC) const noexcept;

      bool SendBool(bool bBool, CRC16* pCRC) const noexcept
         {
      ...
      bool ReadString(std::string& strString, CRC16& CalcCRC, bool bStripCTRL = true) const noexcept;

      // Read a specific size block of data into the buffer
      bool ReadBlock(uint8_t* pBuf, size_t nBytes, CRC16* pCalcCRC = nullptr) const noexcept;

      // Read a single character from the RoboClaw with timeout
      bool ReadByte(uint8_t& uChar) const noexcept;

      // Read the CRC sent from the RoboClaw.  Value is in NATIVE format!
      bool ReadCRC16(CRC16& CRC) const noexcept
         {
         return (ReadIntegralType(CRC));
         }

      // Read the CRC from the RoboClaw and validate against the calculated CRC
      bool CheckCRC(CRC16 CalcCRC) const noexcept
         {
         CRC16 RecdCRC;
      ...
      *****************************************************************************/
      ...
      // Value is -32,767 to +32,767 (-100% to +100%)
      bool DriveSignedDutyCycle(ECommandCode eCmd, int16_t nDutyCycle) const noexcept;

      //** Cmd 35 & 36 Drive Motor Signed Speed
      // Speed is in quadrature pulses/second
      bool DriveSignedSpeed(ECommandCode eCmd, int32_t nSpeed) const noexcept;

      //** Cmd 38 & 39 Drive M1 Signed Speed & Acceleration
      // Sign on speed indicates the direction, acceleration is not signed.
      bool DriveSignedSpeedAccel(ECommandCode eCmd, int32_t nSpeed, uint32_t uAccel) const noexcept;
      ...
      //** Cmd 44 & 45 Buffered Drive Motor With Signed Speed, Accel, & Distance
      bool DriveSignedDutyAccel(ECommandCode eCmd, int16_t nDuty, uint16_t uAccel) const noexcept;

      //** Cmd 52 & 53 Drive Motor With Signed Duty And Acceleration
      //  The duty value is signed and the range is -32768 to +32767(eg. +-100% duty).
      // The accel value range is 0 to 65535(eg maximum acceleration rate is -100% to 100% in 100ms).
      // The manual says accel max is 655359.  Typo????
      bool DriveSignedDutyAccel(int16_t nDuty, uint16_t uAccel) const noexcept;
      ...
      *****************************************************************************/
      ...
      //** Cmd 16 & 17
      bool ReadEncoder(ECommandCode eCmd, uint32_t& uCount, EncoderStatus& Status) const noexcept;
      bool ReadEncoder(ECommandCode eCmd, int32_t& uCount, EncoderStatus& Status) const noexcept;

      //** Cmd 22 & 23
      bool SetEncoder(ECommandCode eCmd, uint32_t uCount) const noexcept;
      bool SetEncoder(ECommandCode eCmd, int32_t nCount) const noexcept;

      // Cmd 18 & 19
      bool ReadEncoderSpeed(ECommandCode eCmd, int32_t& nSpeed, EDirection& eDirection) const noexcept;

      // Cmd 30 & 31
      bool ReadEncoderRawSpeed(ECommandCode eCmd, int32_t& nSpeed, EDirection& eDirection) const noexcept;
      ...
      *****************************************************************************/
      ...
      bool SetMaxCurrentLimit(ECommandCode eCmd, uint32_t uMaxCurrent, uint32_t uMinCurrent = 0) const noexcept;

      //** Cmd 135 & 136 Read Max Current Limit for a motor
      bool ReadMaxCurrentLimit(ECommandCode eCmd, uint32_t& uMaxCurrent, uint32_t& uMinCurrent) const noexcept;
